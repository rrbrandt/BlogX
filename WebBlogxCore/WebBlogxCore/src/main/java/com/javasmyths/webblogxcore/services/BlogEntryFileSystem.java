...
public class BlogEntryFileSystem implements BlogEntryPersistance {
  ...
  static final Logger log = Logger.getLogger(BlogEntryFileSystem.class);
...
// </editor-fold>
  ...
  public void save(BlogEntry blogEntry) {
    try {
      ObjectOutputStream oos
          = new ObjectOutputStream(new FileOutputStream(formatFileName(blogEntry.getBlogEntryDateTime())));
  ...
  @Override
  public List<BlogEntry> get(Date startDate, Date endDate) {
